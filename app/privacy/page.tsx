...
CBIQ ("CBIQ", "we", "us", "our") is a cross-border workforce intelligence platform operated by **GEM Events & Consultancy – FZCO**, DSO-IFZA, IFZA Properties, Dubai Silicon Oasis, Dubai, United Arab Emirates (trade license no. 39377, issued by the Dubai Integrated Economic Zones Authority / IFZA). CBIQ is powered by, and affiliated with, Global Mobility Executive (GME).
...
- **Account information** — your name, work email address, job title, organization, country, and login credentials when you create an account.
- **Survey and contributed data** — responses you provide to the Global Workforce Deployment Survey and other research, including information about your organization's workforce, mobility and HR practices. This is the data used to build our benchmarks.
...
- create **aggregated and anonymized** benchmarks and intelligence from contributed survey data (see Section 6);
...
A core principle of CBIQ is that contributed data is turned into **aggregated, anonymized** intelligence. We do not publish or disclose individual responses, named participants, or organization-level responses in a way that identifies a specific person or company. Benchmarks and vendor intelligence are presented only in aggregate. Where sample sizes are too small to protect confidentiality, we suppress the data rather than display it.
...
We keep personal data only as long as necessary for the purposes described in this policy: for the life of your account and as required afterwards for legal, tax, and legitimate business purposes. Aggregated and anonymized data, which no longer identifies you, may be retained indefinitely.

## 10. Your rights

Depending on your location, you may have the right to access, correct, delete, or restrict the processing of your personal data; to object to processing; to data portability; and to withdraw consent. UK/EU users may also lodge a complaint with their local supervisory authority, and UAE users may have rights under the UAE Personal Data Protection Law. To exercise any right, email **crossborderiq@gemevents.co**. Note that deleting your personal data does not affect previously created aggregated/anonymized benchmarks, which no longer identify you.

## 11. Security

We use technical and organizational measures appropriate to the risk to protect your data, including encryption in transit, access controls, and reputable infrastructure providers. No system is completely secure, and we cannot guarantee absolute security.
